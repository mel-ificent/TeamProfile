...
//Function to create appropriate HTML given the type of employee.  This will be placed in the generated index.html file
renderTeamCards(team){
let teamCards='';
let i = 0;
team.forEach(() =>{
  //specific html code for employees of with the role 'Manager'
if(team[i].getRole()==='Manager'){
  ...
  //specific html code for employees of with the role 'Engineer'
  ...
  //specific html code for employees of with the role 'Intern'
...
//Once all  of the employees have been added, call the renderTeamProfile function
this.renderTeamProfile(teamCards);
}

//This function generates the html content with the employee details and writes the content to a new index.html file
